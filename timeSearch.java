...
public class timeSearch extends JFrame {
    ...
    public timeSearch(String name) {
        ...
        textVarField.setLocation(50,140);
        textVarField.setSize(125, 20);
        contentPane.add(textVarField);

        varLabel = new JLabel("Angiv Virusvariant:");
        varLabel.setLocation(-10,120);
        varLabel.setSize(150, 20);
        varLabel.setHorizontalAlignment(0);
        contentPane.add(varLabel);

        JPanel buttonPanel = new JPanel();
        buttonPanel.setLayout(null);
        buttonPanel.setLocation(0, 130);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    PreparedStatement st = (PreparedStatement) con
                            .prepareStatement("Select count(*) from mutantsearch where timestampPositive >=? and timestampPositive <=? and variant=?");
